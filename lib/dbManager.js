                    ...
                    if (bookmark && bookmark.url) {
                        try {
                            ...
                            chrome.runtime.sendMessage({action: 'fetchUrl', url: bookmark.url}, async response => {
                                ...
                                const { metaKeywords,metaTitle, metaDescription } = response.data;
    
                                bookmark.metaKeywords = metaKeywords;
                                bookmark.metaTitle = metaTitle;
                                bookmark.metaDescription = metaDescription;
                                bookmark.status = 2;
            ...
            return new Promise((resolve, reject) => {
                ...
                request.onsuccess = event => {
                    ...
                    if (limit!= -1 && count >= limit) {
                        ...
                        if (cursor.value.type =="bookmark" && cursor.value.title.toLowerCase().includes(query.toLowerCase())) {
